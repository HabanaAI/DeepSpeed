...
g1_lazy_xfail_tests = {
    ...
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-large-uncased-whole-word-masking-finetuned-squad-question-answering-bf16-CG-noTriton]":
    "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[deepset/roberta-base-squad2-question-answering-bf16-noCG-noTriton]":
    "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-large-uncased-whole-word-masking-finetuned-squad-question-answering-bf16-noCG-noTriton]":
    "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[Jean-Baptiste/roberta-large-ner-english-token-classification-bf16-noCG-noTriton]":
    "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[deepset/roberta-base-squad2-question-answering-bf16-CG-noTriton]":
    "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[deepset/minilm-uncased-squad2-question-answering-bf16-CG-noTriton]":
    "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[j-hartmann/emotion-english-distilroberta-base-text-classification-bf16-CG-noTriton]":
    "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[cross-encoder/ms-marco-MiniLM-L-12-v2-text-classification-bf16-noCG-noTriton]":
    "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[dslim/bert-base-NER-token-classification-bf16-noCG-noTriton]":
    "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[cross-encoder/ms-marco-MiniLM-L-12-v2-text-classification-bf16-CG-noTriton]":
    "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[deepset/minilm-uncased-squad2-question-answering-bf16-noCG-noTriton]":
    "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[j-hartmann/emotion-english-distilroberta-base-text-classification-bf16-noCG-noTriton]":
    "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[dslim/bert-base-NER-token-classification-bf16-CG-noTriton]":
    "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[Jean-Baptiste/roberta-large-ner-english-token-classification-bf16-CG-noTriton]":
    "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-base-multilingual-cased-fill-mask-fp16-CG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[bigscience/bloom-560m-text-generation-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[deepset/minilm-uncased-squad2-question-answering-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-base-multilingual-uncased-fill-mask-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[Jean-Baptiste/roberta-large-ner-english-token-classification-fp16-CG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[FacebookAI/roberta-base-fill-mask-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-large-uncased-whole-word-masking-finetuned-squad-question-answering-fp16-CG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-base-multilingual-uncased-fill-mask-fp16-CG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-large-uncased-fill-mask-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-base-cased-fill-mask-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-large-uncased-fill-mask-fp16-CG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[FacebookAI/roberta-base-fill-mask-fp16-CG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[distilbert/distilgpt2-text-generation-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-base-uncased-fill-mask-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[j-hartmann/emotion-english-distilroberta-base-text-classification-fp16-CG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[facebook/opt-350m-text-generation-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[facebook/opt-125m-text-generation-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[deepset/roberta-base-squad2-question-answering-fp16-CG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-base-cased-fill-mask-fp16-CG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-large-cased-fill-mask-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-large-uncased-whole-word-masking-finetuned-squad-question-answering-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[Norod78/hebrew-bad_wiki-gpt_neo-tiny-text-generation-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-base-multilingual-cased-fill-mask-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[cross-encoder/ms-marco-MiniLM-L-12-v2-text-classification-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[FacebookAI/roberta-large-fill-mask-fp16-CG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[deepset/roberta-base-squad2-question-answering-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[FacebookAI/roberta-large-fill-mask-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-base-uncased-fill-mask-fp16-CG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[dslim/bert-base-NER-token-classification-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[Jean-Baptiste/roberta-large-ner-english-token-classification-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[cross-encoder/ms-marco-MiniLM-L-12-v2-text-classification-fp16-CG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[dslim/bert-base-NER-token-classification-fp16-CG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[deepset/minilm-uncased-squad2-question-answering-fp16-CG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[openai-community/gpt2-text-generation-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-large-cased-fill-mask-fp16-CG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[j-hartmann/emotion-english-distilroberta-base-text-classification-fp16-noCG-noTriton]":
    "Xfail due to FP16 not supported on Gaudi",
    ...
    "Xfail due to fp16 not supported",
    "unit/inference/test_inference.py::TestModelTask::test[cross-encoder/ms-marco-MiniLM-L-12-v2-text-classification-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-multilingual-cased-fill-mask-fp32-CG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-multilingual-uncased-fill-mask-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[FacebookAI/roberta-base-fill-mask-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[FacebookAI/roberta-large-fill-mask-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-uncased-fill-mask-fp32-CG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-large-cased-fill-mask-fp32-CG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[dslim/bert-base-NER-token-classification-fp32-CG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-large-uncased-fill-mask-fp32-CG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[FacebookAI/roberta-large-fill-mask-fp32-CG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[j-hartmann/emotion-english-distilroberta-base-text-classification-fp32-CG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[FacebookAI/roberta-base-fill-mask-fp32-CG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[deepset/minilm-uncased-squad2-question-answering-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-uncased-fill-mask-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-cased-fill-mask-fp32-CG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[dslim/bert-base-NER-token-classification-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[deepset/roberta-base-squad2-question-answering-fp32-CG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-large-uncased-whole-word-masking-finetuned-squad-question-answering-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[Jean-Baptiste/roberta-large-ner-english-token-classification-fp32-CG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-multilingual-cased-fill-mask-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[facebook/opt-350m-text-generation-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[cross-encoder/ms-marco-MiniLM-L-12-v2-text-classification-fp32-CG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[deepset/minilm-uncased-squad2-question-answering-fp32-CG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[j-hartmann/emotion-english-distilroberta-base-text-classification-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-multilingual-uncased-fill-mask-fp32-CG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-large-cased-fill-mask-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-large-uncased-whole-word-masking-finetuned-squad-question-answering-fp32-CG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-large-uncased-fill-mask-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[Jean-Baptiste/roberta-large-ner-english-token-classification-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[deepset/roberta-base-squad2-question-answering-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-cased-fill-mask-fp32-noCG-noTriton-True]":
    "Xfail, due to SW-163097.",
}
...
g2_lazy_xfail_tests = {
    ...
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-large-uncased-whole-word-masking-finetuned-squad-question-answering-bf16-CG-noTriton]": "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[deepset/roberta-base-squad2-question-answering-bf16-noCG-noTriton]": "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[google-bert/bert-large-uncased-whole-word-masking-finetuned-squad-question-answering-bf16-noCG-noTriton]": "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[Jean-Baptiste/roberta-large-ner-english-token-classification-bf16-noCG-noTriton]": "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[deepset/roberta-base-squad2-question-answering-bf16-CG-noTriton]": "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[deepset/minilm-uncased-squad2-question-answering-bf16-CG-noTriton]": "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[j-hartmann/emotion-english-distilroberta-base-text-classification-bf16-CG-noTriton]": "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[cross-encoder/ms-marco-MiniLM-L-12-v2-text-classification-bf16-noCG-noTriton]": "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[dslim/bert-base-NER-token-classification-bf16-noCG-noTriton]": "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[cross-encoder/ms-marco-MiniLM-L-12-v2-text-classification-bf16-CG-noTriton]": "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[deepset/minilm-uncased-squad2-question-answering-bf16-noCG-noTriton]": "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[j-hartmann/emotion-english-distilroberta-base-text-classification-bf16-noCG-noTriton]": "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[dslim/bert-base-NER-token-classification-bf16-CG-noTriton]": "xfail due to SW-184834",
    "unit/inference/test_inference.py::TestModelTaskKIFalse::test[Jean-Baptiste/roberta-large-ner-english-token-classification-bf16-CG-noTriton]": "xfail due to SW-184834",
...
g1_eager_xfail_tests = {
    ...
    "unit/checkpoint/test_universal_checkpoint.py::TestZeROUniversalCheckpointDP::test_dp_world_size_4to2[False-False-True-1-dtype1]":
    "Xfail due to fp16 not supported",
    "unit/inference/test_inference.py::TestInjectionPolicy::test[ws2-fp32-t5]":
    "Xfail, due to SW-182668.",
    "unit/inference/test_inference.py::TestInjectionPolicy::test[ws1-fp32-t5]":
    "Xfail, due to SW-182668.",
...
g3_eager_xfail_tests = {
    "unit/checkpoint/test_zero_optimizer.py::TestZeROCheckpoint::test_load_optimizer_state[3-True-deepspeed_adam-True]":
    "Xfail  due to SW-178702 RuntimeError: Expected all tensors to be on the HPU device, but found at least one input[idx=1] on cpu ",
    "unit/checkpoint/test_zero_optimizer.py::TestZeROCheckpoint::test_not_load_optimizer_state[3-True-deepspeed_adam-True]":
    "Xfail  due to SW-178702 RuntimeError: Expected all tensors to be on the HPU device, but found at least one input[idx=1] on cpu ",
    "unit/runtime/compile/test_compile_zero.py::TestZeRO::test_compile_zero[cpu-3-dtype0]":
    "Xfail  due to SW-178702 RuntimeError: Expected all tensors to be on the HPU device, but found at least one input[idx=1] on cpu ",
    ...
    "This op had not been implemented on HPU backend",
    "unit/runtime/compile/test_compile_zero.py::TestZeRO::test_compile_zero[nvme-3-dtype2]":
    "This op had not been implemented on HPU backend",
    ...
    "Xfail due to SW-187821",
    "unit/inference/quantization/test_intX_quantization.py::TestQuantizedInt::test_float_int8_quantization":
    "Xfail due to SW_182501",
    "unit/inference/quantization/test_intX_quantization.py::TestQuantizedInt::test_float_int4_quantization":
    "Xfail due to SW_182501",
    "unit/runtime/zero/test_zero.py::TestZero3RepeatForwardLoop::test[True]":
    "Xfail due to SW-191939",
    "unit/compression/test_dequantization.py::TestDequantization::test_dequantize":
    "Xfail due to SW-168442",
    "unit/inference/test_human_eval.py::test_human_eval[codellama/CodeLlama-7b-Python-hf]":
    "Xfail due to SW-182759",
...
gpu_xfail_tests = {
    ...
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-cased-fill-mask-fp32-CG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[deepset/minilm-uncased-squad2-question-answering-fp16-CG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[dslim/bert-base-NER-token-classification-fp16-CG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-large-uncased-whole-word-masking-finetuned-squad-question-answering-fp16-CG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[cross-encoder/ms-marco-MiniLM-L-12-v2-text-classification-fp16-CG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-large-cased-fill-mask-fp16-noCG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-multilingual-cased-fill-mask-fp16-noCG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-multilingual-uncased-fill-mask-fp16-CG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[FacebookAI/roberta-base-fill-mask-fp16-CG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-cased-fill-mask-fp16-noCG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-large-uncased-fill-mask-fp16-CG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-large-uncased-fill-mask-fp16-CG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-multilingual-cased-fill-mask-fp16-CG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-cased-fill-mask-fp16-CG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-multilingual-cased-fill-mask-fp16-CG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[FacebookAI/roberta-base-fill-mask-fp16-CG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-uncased-fill-mask-fp16-CG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-large-uncased-fill-mask-fp16-noCG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[FacebookAI/roberta-large-fill-mask-fp16-CG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[FacebookAI/roberta-large-fill-mask-fp16-CG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[FacebookAI/roberta-base-fill-mask-fp16-noCG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[FacebookAI/roberta-base-fill-mask-fp16-noCG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[FacebookAI/roberta-large-fill-mask-fp16-noCG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-large-uncased-fill-mask-fp16-noCG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-multilingual-cased-fill-mask-fp16-noCG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-uncased-fill-mask-fp16-noCG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-uncased-fill-mask-fp16-CG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-multilingual-uncased-fill-mask-fp16-CG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-large-cased-fill-mask-fp16-noCG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-large-cased-fill-mask-fp16-CG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-cased-fill-mask-fp16-noCG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-large-cased-fill-mask-fp16-CG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-uncased-fill-mask-fp16-noCG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[FacebookAI/roberta-large-fill-mask-fp16-noCG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-cased-fill-mask-fp16-CG-noTriton-True]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-multilingual-uncased-fill-mask-fp16-noCG-noTriton-False]":
    "Same failure in Vanilla.",
    "unit/inference/test_inference.py::TestModelTask::test[google-bert/bert-base-multilingual-uncased-fill-mask-fp16-noCG-noTriton-True]":
    "Same failure in Vanilla.",
}
